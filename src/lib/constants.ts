...
export const STATS = [
  { value: '5yr', label: '총 경력', color: 'text-iv-accent' },
  { value: '10만', label: 'MAU 달성', color: 'text-iv-green' },
  { value: '50%', label: '업무 효율', color: 'text-iv-amber' },
  { value: '95점', label: 'Lighthouse', color: 'text-iv-pink' },
] as const;
